    ...
    $(document).ready(function () {
        ...
        $('#nombre_club').on('input', function () {
            ...
            if (nombre_club.length >= 3) {
                delayTimer = setTimeout(() => buscarClubesWGH(nombre_club, 1, false), 300);
            } else {
        ...
        $(document).on('click', '#ver_mas_resultados', function () {
            buscarClubesWGH($(this).data('nombre'), $(this).data('pagina'), true);
        });
        ...
        $(document).on('click', '.seleccionar-club', function () {
            ...
            mostrarTeesWGH(club_name, true); 
        });

        // Función para mostrar tees
        function mostrarTeesWGH(club_name, course_rating) {
        ...
        // Cargar y mostrar los clubes más frecuentes
        ...
        // Guardar un club como habitual en localStorage
        ...
        // Renderizar clubes habituales en el DOM
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        let club = {
                            ...
                            tee_name: $('input[name="tee_select"]:checked').data('tee-name'),
                            par: $('input[name="tee_select"]:checked').data('par'),
                            gender: $('input[name="tee_select"]:checked').data('gender'),
                            rating: $('input[name="tee_select"]:checked').data('rating'),
